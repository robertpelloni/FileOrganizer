...
- When releasing or making major changes:
    ...
    4.  Commit with a message like `chore: bump version to 0.2.0`.
...
- **Commit Protocol**: When asked to commit, simulate the commit message in the output if actual git access is restricted, or use `git commit` if available.
