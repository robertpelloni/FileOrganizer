...
|---|---|---|---|---|---|---|
| libs/fstlib | `libs/fstlib` | v0.1.1 | `4d61c19` | 2025-02-07 | 180 | [Link](https://github.com/fstpackage/fstlib) |
| libs/hash-library | `libs/hash-library` | hash_library_v8 | `d389d18` | 2021-09-29 | 11 | [Link](https://github.com/stbrumme/hash-library) |
| libs/libheif | `libs/libheif` | v1.20.1 | `f4943490` | 2025-12-28 | 4913 | [Link](https://github.com/strukturag/libheif) |
...
| libs/ImageMagick | `libs/ImageMagick` | 7.1.2-11 | `2c08c2311` | 2025-12-27 | 23489 | [Link](https://github.com/ImageMagick/ImageMagick) |
...
| libs/openexr | `libs/openexr` | v3.4-alpha | `166bc483` | 2025-12-18 | 2807 | [Link](https://github.com/AcademySoftwareFoundation/openexr) |
| libs/OpenImageIO | `libs/OpenImageIO` | v3.0.0.0-beta1 | `ff8965449` | 2025-12-22 | 6391 | [Link](https://github.com/AcademySoftwareFoundation/OpenImageIO) |
| libs/OpenColorIO | `libs/OpenColorIO` | v2.1.0 | `1d77ecda` | 2025-12-10 | 1574 | [Link](https://github.com/AcademySoftwareFoundation/OpenColorIO) |
| libs/OpenTimelineIO | `libs/OpenTimelineIO` | v0.18.1 | `4af7407` | 2025-12-18 | 820 | [Link](https://github.com/AcademySoftwareFoundation/OpenTimelineIO) |
| libs/OpenCue | `libs/OpenCue` | v1.13.8 | `9d7fafcd` | 2025-12-28 | 1242 | [Link](https://github.com/AcademySoftwareFoundation/OpenCue) |
| libs/OpenRV | `libs/OpenRV` | v3.0.0 | `7351285` | 2025-12-18 | 556 | [Link](https://github.com/AcademySoftwareFoundation/OpenRV) |
| libs/openfx | `libs/openfx` | OFX_Release_1.5.1 | `ab77951` | 2025-11-20 | 793 | [Link](https://github.com/AcademySoftwareFoundation/openfx) |
| libs/openapv | `libs/openapv` | v0.2.0.4 | `1a7845a` | 2025-12-16 | 208 | [Link](https://github.com/AcademySoftwareFoundation/openapv) |
| libs/libxml2 | `libs/libxml2` | v2.15.0 | `9827e6e4` | 2025-12-22 | 7730 | [Link](https://github.com/GNOME/libxml2) |
...
| libs/SysmonForLinux | `libs/SysmonForLinux` | 1.4.0.0 | `412cb37` | 2025-07-03 | 130 | [Link](https://github.com/microsoft/SysmonForLinux) |
| libs/fast-lzma2 | `libs/fast-lzma2` | v1.0.1 | `b44b79b` | 2025-10-26 | 244 | [Link](https://github.com/conor42/fast-lzma2) |
...
| libs/libzip | `libs/libzip` | v1.11.4 | `a1364389` | 2025-12-01 | 3661 | [Link](https://github.com/nih-at/libzip) |
| libs/libiconv | `libs/libiconv` | libiconv-1.17-1 | `880a1fa` | 2024-10-27 | 44 | [Link](https://github.com/winlibs/libiconv) |
| libs/ckmame | `libs/ckmame` | v2.1 | `ad23f21b` | 2025-12-18 | 3202 | [Link](https://github.com/nih-at/ckmame) |
| libs/nihtest | `libs/nihtest` | v1.9.1 | `3adeb60` | 2025-12-18 | 136 | [Link](https://github.com/nih-at/nihtest) |
...
| libs/icu4c | `libs/icu4c` | ICU-75.1 | `b5cdbf1d` | 2024-10-31 | 40 | [Link](https://github.com/winlibs/icu4c) |
...
| libs/FFmpeg | `libs/FFmpeg` | n8.1-dev | `224b3ff82a` | 2025-12-27 | 122273 | [Link](https://github.com/FFmpeg/FFmpeg) |
| libs/hashcat | `libs/hashcat` | v7.1.2 | `2d71af371` | 2025-11-20 | 11055 | [Link](https://github.com/hashcat/hashcat) |
| libs/radare2 | `libs/radare2` | 6.0.7 | `01a62d7268` | 2025-12-27 | 34534 | [Link](https://github.com/radareorg/radare2) |
| libs/C | `libs/C` | - | `e5dad3fa` | 2023-09-27 | 1536 | [Link](https://github.com/TheAlgorithms/C) |
| libs/vlc | `libs/vlc` | 4.0.0-dev | `36464b937d` | 2025-12-26 | 108852 | [Link](https://github.com/videolan/vlc) |
| libs/sumatrapdf | `libs/sumatrapdf` | 3.2 | `2a56cb2f8` | 2025-12-27 | 16092 | [Link](https://github.com/sumatrapdfreader/sumatrapdf) |
| libs/mpv | `libs/mpv` | v0.41.0 | `a58dd8ac41` | 2025-12-27 | 54485 | [Link](https://github.com/mpv-player/mpv) |
| libs/sqlite | `libs/sqlite` | version-3.51.0 | `35f37ec959` | 2025-12-27 | 31129 | [Link](https://github.com/sqlite/sqlite) |
...
| libs/opencv | `libs/opencv` | 4.12.0 | `40ab411032` | 2025-12-27 | 35898 | [Link](https://github.com/opencv/opencv) |
| libs/MediaInfoLib | `libs/MediaInfoLib` | v25.10 | `558a4d6bf` | 2025-12-27 | 9633 | [Link](https://github.com/MediaArea/MediaInfoLib) |
| libs/MediaInfo | `libs/MediaInfo` | v25.10 | `6722fae3d` | 2025-12-27 | 2717 | [Link](https://github.com/MediaArea/MediaInfo) |
...
| libs/libjpeg-turbo | `libs/libjpeg-turbo` | 3.1.3 | `af9c1c26` | 2025-12-10 | 2762 | [Link](https://github.com/libjpeg-turbo/libjpeg-turbo) |
| libs/jhead | `libs/jhead` | 3.08 | `db00efb` | 2025-05-07 | 484 | [Link](https://github.com/Matthias-Wandel/jhead) |
| libs/libexif | `libs/libexif` | libexif-0_6_25-release | `cdfe2db` | 2025-12-18 | 1477 | [Link](https://github.com/libexif/libexif) |
| libs/getopt-win32 | `libs/getopt-win32` | - | `b3de5c2` | 2017-08-30 | 3 | [Link](https://github.com/nanoporetech/getopt-win32) |
| libs/raylib | `libs/raylib` | 5.5 | `05f51436` | 2025-12-27 | 9272 | [Link](https://github.com/raysan5/raylib) |
| libs/lvgl | `libs/lvgl` | v9.4.0 | `18354afc0` | 2025-12-27 | 12135 | [Link](https://github.com/lvgl/lvgl) |
...
| libs/xxHash | `libs/xxHash` | v0.7.4 | `6697932` | 2025-12-17 | 2052 | [Link](https://github.com/Cyan4973/xxHash) |
| libs/libgit2 | `libs/libgit2` | v1.9.0 | `3ac4c0adb` | 2025-12-20 | 16074 | [Link](https://github.com/libgit2/libgit2) |
| libs/dokany | `libs/dokany` | v2.3.1.1000 | `ead52a9` | 2025-12-11 | 1756 | [Link](https://github.com/dokan-dev/dokany) |
| libs/pngquant | `libs/pngquant` | 3.0.3 | `e3bdc7c` | 2025-07-07 | 1208 | [Link](https://github.com/kornelski/pngquant) |
| libs/dunst | `libs/dunst` | v1.13.0 | `e2593d3` | 2025-11-21 | 2584 | [Link](https://github.com/dunst-project/dunst) |
...
| libs/util-linux | `libs/util-linux` | v2.42-start | `e4656fa97` | 2025-12-17 | 21447 | [Link](https://github.com/util-linux/util-linux) |
...
| vcpkg | `vcpkg` | 2025.12.12 | `11bbc873e0` | 2025-12-27 | 27312 | [Link](https://github.com/microsoft/vcpkg) |
